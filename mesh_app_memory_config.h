...
#define MESH_CFG_MAX_GATT_CONNECTIONS           2
...
#define MESH_CFG_FRIEND_MAX_SUBS_LIST           4
#define MESH_CFG_FRIEND_MAX_TOTAL_CACHE         16
#define MESH_CFG_FRIEND_MAX_SINGLE_CACHE        4
